...
ALTER VIEW [dbo].[UserInfoSearch]
	AS SELECT [User].ID, [User].FirstName, [User].LastName, [User].Email, [User].DisplayName, [PersonalDetails].PhoneNumber, [PersonalDetails].Address, [PersonalDetails].City, [PersonalDetails].Country, [Permission].Name 
	FROM 
