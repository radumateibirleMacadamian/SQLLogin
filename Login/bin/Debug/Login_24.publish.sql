...
GO
PRINT N'Altering [dbo].[UserInfoSearch]...';


GO
ALTER VIEW [dbo].[UserInfoSearch]
	AS SELECT CONCAT ([User].ID, ' ', [User].FirstName, ' ', [User].LastName, ' ', [User].Email, ' ', [User].DisplayName, ' ', [PersonalDetails].PhoneNumber, ' ', [PersonalDetails].Address, ' ', [PersonalDetails].City, ' ', [PersonalDetails].Country, ' ', [Permission].Name) AS SearchString
	FROM 
...
AS
RETURN(
	SELECT * FROM UserInfoSearch WHERE SearchString LIKE CONCAT('%',@SearchTerm,'%')
)
GO
/*
