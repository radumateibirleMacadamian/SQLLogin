...
AS
	DECLARE
	@RetrievedFirstName nvarchar(40),
	@RetrievedLastName nvarchar(20),
	@RetrievedPass nvarchar(64),
	@RetrievedID int = -1,
	@HashedPass nchar(64)

	SELECT @RetrievedPass = Password, @RetrievedID = ID, @RetrievedFirstName = FirstName, @RetrievedLastName = LastName FROM [User]
	WHERE Email = @Email
	...
	BEGIN
		...
		RETURN DisplayName(@RetrievedFirstName, @RetrievedLastName)
	END
